...
bool VoodooI2CELANTouchpadDriver::start(IOService* provider) {
    ...
    interrupt_source = IOInterruptEventSource::interruptEventSource(this, OSMemberFunctionCast(IOInterruptEventAction, this, &VoodooI2CELANTouchpadDriver::interruptOccurred), api, 0);
    if (!interrupt_source) {
